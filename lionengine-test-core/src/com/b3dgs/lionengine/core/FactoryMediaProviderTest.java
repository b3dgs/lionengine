...
{
    /** Resources path. */
    public static final String PATH = UtilFile.getPath("resources", "graphic");
    ...
    {
        Assert.assertEquals(FactoryMediaProviderTest.PATH, Core.MEDIA.create("resources", "graphic")
                .getPath());
    }
