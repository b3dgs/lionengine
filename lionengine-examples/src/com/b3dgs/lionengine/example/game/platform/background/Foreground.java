        ...
        extends BackgroundPlatform
{
     ...
     */
    Foreground(Resolution source, double scaleH, double scaleV)
    {
        super(null, 0, 0);
        nominal = 210;
        height = 0.0;
            ...
            implements BackgroundComponent
    {
        ...
        {
            final Sprite sprite = Drawable.loadSprite(UtilityMedia.get("calc.png"));
            sprite.load(false);
            ...
            implements BackgroundComponent
    {
        ...
        {
            final Sprite back = Drawable.loadSprite(UtilityMedia.get("back.png"));
            back.load(false);
            ...
            anim = Drawable.loadSpriteAnimated(UtilityMedia.get("anim.png"), 7, 1);
            anim.load(false);
            anim.play(animation);
            this.water = water;
            height = 0.0;
