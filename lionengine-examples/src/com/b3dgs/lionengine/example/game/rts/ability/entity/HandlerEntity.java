...
import com.b3dgs.lionengine.example.game.rts.ability.ControlPanel;
        ...
        extends HandlerEntityRts<ResourceType, Tile, Entity, ControlPanel>
{
     ...
     */
    public HandlerEntity(CameraRts camera, CursorRts cursor, ControlPanel controlPanel, Map map, TextGame text)
    {
