...
import com.b3dgs.lionengine.example.game.rts.skills.ControlPanel;
        ...
        extends HandlerEntityRts<ResourceType, Tile, Entity, ControlPanel>
{
     ...
     */
    public HandlerEntity(CameraRts camera, Cursor cursor, ControlPanel controlPanel, Map map, TextGame text)
    {
