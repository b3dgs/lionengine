        ...
        extends Missile
{
     ...
     */
    public MissileRear(SetupSurfaceGame setup, FactoryEffect factoryEffect, HandlerEffect handlerEffect)
    {
        super(setup, 136, factoryEffect, handlerEffect);
    }
}
