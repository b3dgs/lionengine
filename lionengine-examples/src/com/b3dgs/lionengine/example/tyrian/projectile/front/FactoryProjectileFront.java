...
/**
 * Projectile front factory.
 */
public final class FactoryProjectileFront
{
    /**
            ...
            HandlerEffect handlerEffect)
    {
        try
        {
            final StringBuilder clazz = new StringBuilder(FactoryProjectileFront.class.getPackage().getName());
