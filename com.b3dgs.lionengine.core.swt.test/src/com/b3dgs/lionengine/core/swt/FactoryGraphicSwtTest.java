 ...
 */
public class FactoryGraphicSwtTest
{
    /** Image. */
    ...
    {
        Engine.start(FactoryGraphicSwtTest.class.getName(), Version.DEFAULT, FactoryGraphicSwtTest.class);

        final File temp = Files.createTempFile("save", "png").toFile();
        temp.deleteOnExit();
        mediaImage = new MediaSwt("image.png");
        mediaRaster = new MediaSwt("raster.xml");
        mediaSave = new MediaSwt(temp.getAbsolutePath());
        mediaRasterError = new MediaSwt("raster_error.xml");
    ...
    {
        Assert.assertNotNull(Graphics.getImageBuffer(new MediaSwt("null")));
    }
    ...
    {
        Assert.assertNotNull(Graphics.getImageBuffer(new MediaSwt("wrong_image.png")));
    }
