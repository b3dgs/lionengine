...
public class UtilityImageTest
{
    ...
    {
        Engine.start("UtilityImageTest", Version.create(1, 0, 0), "resources");
    }
    ...
    public void testUtilityImage()
    {
        ...
        UtilityImage.saveImage(image1, UtilityMedia.get("testImage.png"));
        final ImageBuffer loaded = UtilityImage.getImageBuffer(UtilityMedia.get("testImage.png"), false);
        Assert.assertEquals(image1.getWidth(), loaded.getWidth());
        Assert.assertEquals(image1.getHeight(), loaded.getHeight());
        final File file = new File(UtilityMedia.get("resources", "testImage.png").getPath());
