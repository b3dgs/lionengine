...
public class MidiTest
{
    ...
    public void testMidi() throws InterruptedException
    {
        ...
        try
        {
            midi = AudioMidi.loadMidi(Media.create(Media.getPath("resources", "music.mid")));
        ...
        try
        {
            final Midi midi2 = AudioMidi.loadMidi(Media.create(Media.getPath("resources", "fail.mid")));
            midi2.play(false);
            Assert.fail();
        }
        catch (final LionEngineException exception)
        ...
        final Midi midi2 = AudioMidi.loadMidi(Media.create(Media.getPath("resources", "music.mid")));
