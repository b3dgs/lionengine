...
public class ImageInfoTest
{
    ...
    {
        Engine.start("ImageInfoTest", Version.create(1, 0, 0), "resources");
        try
        {
            ImageInfo.get(null);
            Assert.fail();
        ...
        final ImageInfo infoTiff = ImageInfo.get(Media.create(Media.getPath("dot.tif")));
        ...
        try
        {
            final ImageInfo infoTga = ImageInfo.get(Media.create(Media.getPath("dot.tga")));
