        ...
        implements ImageBuffer
{
     ...
     */
    ImageBufferImpl(BufferedImage bufferedImage)
    {
    ...
    {
        return new GraphicImpl(bufferedImage.createGraphics());
    }
    ...
    {
        return ImageBufferImpl.getTransparency(bufferedImage.getTransparency());
    }
}
