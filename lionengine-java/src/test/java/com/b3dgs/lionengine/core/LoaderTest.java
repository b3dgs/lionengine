...
public class LoaderTest
{
    ...
    {
        Engine.start("LoaderTest", Version.create(1, 0, 0), Media.getPath("src", "test", "resources"));
    ...
    {
        Engine.start("LoaderFilterTest", Version.create(1, 0, 0), Media.getPath("src", "test", "resources"));
