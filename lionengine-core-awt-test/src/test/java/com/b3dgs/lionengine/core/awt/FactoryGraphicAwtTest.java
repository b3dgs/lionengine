...
public class FactoryGraphicAwtTest
{
    ...
    public static void setUp() throws IOException
    {
        ...
        temp.deleteOnExit();
        mediaImage = new MediaAwt("image.png");
        mediaRaster = new MediaAwt("raster.xml");
    ...
    {
        Assert.assertNotNull(Graphics.getImageBuffer(new MediaAwt("null")));
    }
    ...
    {
        Assert.assertNotNull(Graphics.getImageBuffer(new MediaAwt("wrong_image.png")));
    }
