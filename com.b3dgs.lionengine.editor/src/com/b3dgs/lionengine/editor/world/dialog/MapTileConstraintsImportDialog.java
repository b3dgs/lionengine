 ...
 */
public class MapTileConstraintsImportDialog extends AbstractDialog
{
    /** Icon. */
     ...
     */
    public MapTileConstraintsImportDialog(Shell parent)
    {
        super(parent,
              Messages.ImportMapTileConstraintsDialog_Title,
              Messages.ImportMapTileConstraintsDialog_HeaderTitle,
              Messages.ImportMapTileConstraintsDialog_HeaderDesc,
              ICON);
        createDialog();
    ...
    void browseConstraintsLocation()
    {
        ...
        {
            Messages.ImportMapTileConstraintsDialog_ConstraintsConfigFileFilter
        }, new String[]
        {
            XML
        });
    ...
    void onConstraintsConfigLocationSelected(File path)
    {
        ...
        {
            setTipsMessage(AbstractDialog.ICON_ERROR, Messages.ImportMapTileConstraintsDialog_ErrorConstraints);
        }
        updateTipsLabel();
    }
    ...
    private void createConstraintsLocationArea(Composite content)
    {
        ...
        locationLabel.setText(Messages.ImportMapTileConstraintsDialog_ConstraintsLocation);
