 ...
 */
public class FolderTypeEditHandler
{
    /** Type node. */
    ...
    private static XmlNode getRoot(Media media)
    {
        ...
        {
            root = Stream.createXmlNode(FolderTypeEditHandler.NODE_TYPE);
            final XmlNode typeName = Stream.createXmlNode(FolderTypeEditHandler.NODE_NAME);
            typeName.setText(FolderTypeEditHandler.DEFAULT_NAME);
            root.add(typeName);
        }
        return root;
    }
    ...
    public void execute(EPartService partService, Shell parent)
    {
        ...
        {
            Verbose.exception(FolderTypeEditHandler.class, "execute", exception);
        }
    }
}
