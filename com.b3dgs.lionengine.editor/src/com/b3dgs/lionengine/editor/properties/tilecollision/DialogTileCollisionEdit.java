 ...
 */
public class DialogTileCollisionEdit
        extends AbstractDialog
{
    /** Tile collision icon. */
    private static final Image ICON_TILE_COLLISION = UtilEclipse.getIcon("dialog", "edit-tilesheets.png");
     ...
     */
    public DialogTileCollisionEdit(Shell parent)
    {
        super(parent, Messages.Dialog_TileCollision_Title, Messages.Dialog_TileCollision_HeaderTitle,
                Messages.Dialog_TileCollision_HeaderDesc, ICON_TILE_COLLISION);
    }
