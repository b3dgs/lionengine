...
{
    /** Tile formulas icon. */
    private static final Image ICON_FORMULAS = UtilEclipse.getIcon(FOLDER, "tileformulas.png");
    /** Tile formula icon. */
    private static final Image ICON_FORMULA = UtilEclipse.getIcon(FOLDER, "tileformula.png");
