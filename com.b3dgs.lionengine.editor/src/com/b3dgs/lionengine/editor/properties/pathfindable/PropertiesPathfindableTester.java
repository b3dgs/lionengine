 ...
 */
package com.b3dgs.lionengine.editor.properties.pathfindable;
...
public final class PropertiesPathfindableTester extends PropertyTester
{
    ...
    private static boolean check(PropertiesModel model, Object data, String property)
    {
        ...
        {
            result = !model.hasProperty(PathfindableConfig.PATHFINDABLE);
        }
        else if (PROPERTY_PATHFINDABLE_EDIT.equals(property) && PathfindableConfig.PATHFINDABLE.equals(data))
        {
            result = model.hasProperty(PathfindableConfig.PATHFINDABLE);
        }
        else if (PROPERTY_PATHFINDABLE_DISABLE.equals(property) && PathfindableConfig.PATHFINDABLE.equals(data))
        {
            result = model.hasProperty(PathfindableConfig.PATHFINDABLE);
        }
        else
