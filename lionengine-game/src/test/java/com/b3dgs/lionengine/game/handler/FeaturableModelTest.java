...
public class FeaturableModelTest
{
    ...
    public void testFeaturableCompatible()
    {
        ...
        featurable.prepareFeatures(new HandlableModel(), new Services());
    ...
    public void testServiceAnnotation()
    {
        ...
        featurable.prepareFeatures(new HandlableModel(), services);
    ...
    public void testServiceAnnotationTwice()
    {
        ...
        featurable.prepareFeatures(handlable, services);
     ...
     * Mock feature itself.
     */
    private static class FeatureItself extends HandlableModel implements Feature
    {
        @Override
        public void prepare(Handlable owner, Services services)
        {
