 ...
 * <p>
 * {@link State} <b>must not implements this interface</b> to check input, but must instead use specific interfaces,
 * such as:
 * </p>
 * <ul>
 * <li>{@link StateInputDirectionalUpdater}</li>
 * <li>{@link StateInputPointerUpdater}</li>
 * </ul>
 * 
